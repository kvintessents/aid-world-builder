<template>
    <div ref="wrapper" class="attributes-wrapper">
        <table class="attributes">
            <tbody>
                <NodeAttribute
                    ...
                    :index="index"
                    :data-order="index"
                    :size-cache-breaker="sizeCacheBreakerAdded"
                    @startReorder="reorderStart"
                />
            </tbody>
        </table>

        <div v-if="reorderBox" class="reorder-box" :style="reorderBoxStyle" />
